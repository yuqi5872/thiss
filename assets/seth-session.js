(function(){
  ...
  function setFeatureType(event){featureType=event.currentTarget.dataset.type;document.querySelectorAll('.type-chip').forEach(function(chip){chip.classList.toggle('active',chip.dataset.type===featureType)})}
